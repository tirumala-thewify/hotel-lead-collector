...
COLUMNS.push(
  ...
  ['WhatsApp Numbers', (hotel) => joinValues(hotel.whatsapp_contacts, (item) => item.normalized)],
  ['WhatsApp Status', (hotel) => hotel.whatsapp_contacts?.some((item) => item.status === 'CONFIRMED_PUBLIC') ? 'CONFIRMED_PUBLIC' : 'UNKNOWN'],
  ['WhatsApp Source URLs', (hotel) => joinValues(hotel.whatsapp_contacts, (item) => item.source_url)],
